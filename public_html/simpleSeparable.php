<?php
$pageTitle = 'Simple Separable State - State Separator';
$pageDescription = 'Example: A simple separable state with real entries.';
$currentPage = 'examples';
$isExample = true;
$exampleTitle = 'Simple Separable State';
$exampleDesc = 'Diagonal density matrix — clearly separable';
include '_header.php';
include '_nav.php';
?>
